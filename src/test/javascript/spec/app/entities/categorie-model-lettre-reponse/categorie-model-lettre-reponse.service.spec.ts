...
describe('Service Tests', () => {
  describe('CategorieModelLettreReponse Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a CategorieModelLettreReponse', async () => {
        ...
        service
          .create(new CategorieModelLettreReponse(null))
          .pipe(take(1))
          .subscribe(resp => (expectedResult = resp));
      ...
      it('should update a CategorieModelLettreReponse', async () => {
        const returnedFromService = Object.assign(
          {
            libelle: 'BBBBBB'
          },
      ...
      it('should return a list of CategorieModelLettreReponse', async () => {
        const returnedFromService = Object.assign(
          {
            libelle: 'BBBBBB'
          },
      ...
      it('should delete a CategorieModelLettreReponse', async () => {
