...
describe('Service Tests', () => {
  describe('ModelLettreReponse Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a ModelLettreReponse', async () => {
        ...
        service
          .create(new ModelLettreReponse(null))
          .pipe(take(1))
          .subscribe(resp => (expectedResult = resp));
      ...
      it('should update a ModelLettreReponse', async () => {
        const returnedFromService = Object.assign(
          {
            libelle: 'BBBBBB',
            code: 'BBBBBB',
      ...
      it('should return a list of ModelLettreReponse', async () => {
        const returnedFromService = Object.assign(
          {
            libelle: 'BBBBBB',
            code: 'BBBBBB',
      ...
      it('should delete a ModelLettreReponse', async () => {
