...
describe('Service Tests', () => {
  describe('LeService Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a LeService', async () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            createdAt: currentDate.format(DATE_TIME_FORMAT),
      ...
      it('should update a LeService', async () => {
        const returnedFromService = Object.assign(
          {
            title: 'BBBBBB',
            description: 'BBBBBB',
      ...
      it('should return a list of LeService', async () => {
        const returnedFromService = Object.assign(
          {
            title: 'BBBBBB',
            description: 'BBBBBB',
      ...
      it('should delete a LeService', async () => {
