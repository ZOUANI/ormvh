...
describe('Service Tests', () => {
  describe('CourrierObject Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a CourrierObject', async () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            createdAt: currentDate.format(DATE_TIME_FORMAT),
        ...
        service
          .create(new CourrierObject(null))
          .pipe(take(1))
          .subscribe(resp => (expectedResult = resp));
      ...
      it('should update a CourrierObject', async () => {
        const returnedFromService = Object.assign(
          {
            title: 'BBBBBB',
            category: 'BBBBBB',
      ...
      it('should return a list of CourrierObject', async () => {
        const returnedFromService = Object.assign(
          {
            title: 'BBBBBB',
            category: 'BBBBBB',
      ...
      it('should delete a CourrierObject', async () => {
