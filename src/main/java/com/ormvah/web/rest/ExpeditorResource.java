...
public class ExpeditorResource {
    ...
    public ResponseEntity<List<Expeditor>> getAllExpeditors(ExpeditorCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
