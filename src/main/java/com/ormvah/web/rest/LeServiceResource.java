...
public class LeServiceResource {
    ...
    public ResponseEntity<List<LeService>> getAllLeServices(LeServiceCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
